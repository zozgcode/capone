...
import { JessicaRebeccaAndersonTxData } from "./tXdata";

export default function JessicaRebeccaAnderson() {
  return (
    <div className={style.transaction_history}>
      <div className={style.in_transaction_history}>
        ...
        {JessicaRebeccaAndersonTxData.length === 0 && (
          <div className={style.no_transaction_yet}>
            No transaction yet
          </div>
        )}
        {JessicaRebeccaAndersonTxData.map((aTxData, i) => (
